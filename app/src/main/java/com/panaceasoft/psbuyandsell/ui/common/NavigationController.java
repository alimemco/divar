...
import com.panaceasoft.psbuyandsell.ui.chat.chat.ChatNotFragment;
...
import com.panaceasoft.psbuyandsell.ui.contactus.ContactUsActivity;
...
import com.panaceasoft.psbuyandsell.ui.dashboard.DashBoardSearchActivity;
...
import com.panaceasoft.psbuyandsell.ui.item.myitem.MyItemListActivity;
...
import com.panaceasoft.psbuyandsell.ui.terms.TermsActivity;
...
import com.panaceasoft.psbuyandsell.ui.user.ProfileNotFragment;
...
public class NavigationController {
    ...
    public void navigateToUserProfileNot(MainActivity mainActivity) {
        if (checkFragmentChange(RegFragments.HOME_USER_LOGIN)) {
            try {
                ProfileNotFragment fragment = new ProfileNotFragment();
                mainActivity.getSupportFragmentManager().beginTransaction()
                        .replace(containerId, fragment)
                        .commitAllowingStateLoss();
            } catch (Exception e) {
...
//    }
    ...
    public void navigateToContactUs(Activity activity) {
    ...
    public void navigateToChatNot(MainActivity mainActivity) {
        if (checkFragmentChange(RegFragments.HOME_FILTER)) {
            try {
                ChatNotFragment fragment = new ChatNotFragment();
                mainActivity.getSupportFragmentManager().beginTransaction()
                        .replace(containerId, fragment)
                        .commitAllowingStateLoss();
            } catch (Exception e) {
    ...
    public void navigateToTermsActivity(Activity activity) {
    ...
    public void navigateToDashBoardSearch(Activity activity) {
        Intent intent = new Intent(activity, DashBoardSearchActivity.class);
        activity.startActivity(intent);
    }
    ...
    public void navigateToMyItemListActivity(Activity activity,String userId) {
        Intent intent = new Intent(activity, MyItemListActivity.class);
        intent.putExtra(Constants.USER_ID,userId);
        activity.startActivity(intent);
    }
    ...
    public void navigateToHomeFilteringActivity(FragmentActivity mainActivity, ItemParameterHolder itemParameterHolder, String titleName, String itemLat, String itemLng, String mapMiles,String cityID) {

        if (cityID != null) {
            itemParameterHolder.location_id = cityID;
        }
...
//    }
    ...
    public void getImageFromGallery(Activity activity) {
        ...
        if (Utils.isStoragePermissionGranted(activity)) {
            ...
            activity.startActivityForResult(Intent.createChooser(intent, "انتخاب تصویر"), Constants.RESULT_CODE__IMAGE_CATEGORY);
        }
