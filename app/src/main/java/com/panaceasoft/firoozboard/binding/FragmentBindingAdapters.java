package com.panaceasoft.firoozboard.binding;
...
import com.panaceasoft.firoozboard.viewobject.common.SyncStatus;
...
public class FragmentBindingAdapters {
    ...
    public void bindImage(ImageView imageView, String imageUrl) {
        ...
        if(isValid(imageView, imageUrl)) {
            ...
            if(imageView != null) {
                imageView.setImageResource(R.drawable.ic_post_no_image);
            }
