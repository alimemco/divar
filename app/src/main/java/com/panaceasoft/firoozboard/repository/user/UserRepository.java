package com.panaceasoft.firoozboard.repository.user;
...
//                            userDao.insert(userLogin);
        ...
        statusLiveData.addSource(apiResponse, response -> {
            ...
            if (response.isSuccessful()) {
                ...
                appExecutors.diskIO().execute(() -> {
                    ...
                    statusLiveData.postValue(Resource.successWithMsg("موفق", response.body));
                });
    ...
    public LiveData<Resource<Boolean>> deletePostUser(String loginUserId) {
        ...
        appExecutors.networkIO().execute(() -> {
            ...
            try {
                response = psApiService.deleteUser(
                        Config.API_KEY ,loginUserId).execute();
                ...
                if (apiResponse.isSuccessful()) {
                    ...
                    try {
                        ...
                        userDao.getUserLoginData(loginUserId);
