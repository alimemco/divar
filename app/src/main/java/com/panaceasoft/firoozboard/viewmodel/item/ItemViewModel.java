...
import com.panaceasoft.firoozboard.repository.item.ItemRepository;
...
public class ItemViewModel extends PSViewModel {
    ...
    ItemViewModel(ItemRepository repository) {
        ...
        uploadItemData = Transformations.switchMap(uploadItemObj, obj -> {
            ...
            return repository.uploadItem(obj.catId, obj.subCatId, obj.itemTypeId, obj.itemPriceTypeId, obj.conditionId, obj.locationId, obj.remark,
...
//        }
    ...
    class UploadItemTmpDataHolder {
        ...
        String catId, subCatId, itemTypeId, itemPriceTypeId, conditionId, locationId, remark, description, highlightInfo, price, dealOptionId, brand, businessMode,
                isSoldOut, title, address, lat, lng,  itemId,userId;

        public UploadItemTmpDataHolder(String catId, String subCatId, String itemTypeId, String itemPriceTypeId, String conditionId, String locationId, String remark, String description, String highlightInfo, String price, String dealOptionId, String brand, String businessMode, String isSoldOut, String title, String address, String lat, String lng, String itemId, String userId) {
            this.catId = catId;
