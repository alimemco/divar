package com.panaceasoft.firoozboard.viewmodel.comment;
...
import com.panaceasoft.firoozboard.repository.comment.CommentRepository;
...
public class CommentListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.panaceasoft.firoozboard.viewmodel.comment.CommentListViewModel.TmpDataHolder> sendCommentHeaderPostDataObj = new MutableLiveData<>();
    ...
    public void setSendCommentHeaderPostDataObj(String itemId,
        ...
        if (!isLoading) {
            com.panaceasoft.firoozboard.viewmodel.comment.CommentListViewModel.TmpDataHolder tmpDataHolder = new com.panaceasoft.firoozboard.viewmodel.comment.CommentListViewModel.TmpDataHolder();
