...
import com.panaceasoft.firoozboard.databinding.FragmentChatBinding;
import com.panaceasoft.firoozboard.databinding.ItemRatingEntryBinding;
import com.panaceasoft.firoozboard.ui.chat.adapter.ChatListAdapter;
...
import com.panaceasoft.firoozboard.viewobject.messageHolder.Chat;
import com.panaceasoft.firoozboard.viewobject.messageHolder.Message;
import com.panaceasoft.firoozboard.viewobject.messageHolder.UserStatusHolder;
    ...
    protected void initAdapters() {
        ...
        if (getActivity() != null) {
            ...
            if (chatViewModel.itemImagePath.equals(Constants.EMPTY_STRING) || chatViewModel.itemName.equals(Constants.EMPTY_STRING) || chatViewModel.itemPrice.equals(Constants.EMPTY_STRING)
                    || chatViewModel.itemConditionName.equals(Constants.EMPTY_STRING)) {
                        ...
                        if (chatViewModel.offerMessage.offerStatus == Constants.CHAT_STATUS_ACCEPT) {
                            ...
                            chatViewModel.setSaveMessagesToFirebaseObj(
                                    new Message(
                                            Utils.generateKeyForChatHeadId(loginUserId, chatViewModel.receiverId),
                                            chatViewModel.itemId,
                                            chatViewModel.offerItemPrice + " " + getString(R.string.item_entry_detail__price_symbol),
                                            Constants.CHAT_TYPE_TEXT,
                                            loginUserId,
...
//                                            chatViewModel.itemId, 0)
    ...
    private List<Message> regenerateMessageList(List<Message> messageList) {
        ...
        for (int i = 0; i < messageList.size(); i++) {
            ...
            // DateConvert Checking
//            DateConvert date = Utils.getDate(messageList.get(i).timestamp);
