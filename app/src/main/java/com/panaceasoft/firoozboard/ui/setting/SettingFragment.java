...
import com.panaceasoft.firoozboard.databinding.FragmentSettingBinding;
import com.panaceasoft.firoozboard.ui.common.PSFragment;
import com.panaceasoft.firoozboard.utils.AutoClearedValue;
import com.panaceasoft.firoozboard.utils.GetSizeTaskForGlide;
...
public class SettingFragment extends PSFragment {
    ...
    protected void initUIAndActions() {
        ...
        binding.get().appTermsTextView.setOnClickListener(view -> navigationController.navigateToTermsActivity(getActivity()));
        binding.get().appContactTextView.setOnClickListener(view -> navigationController.navigateToContactUs(getActivity()));
