...
import com.panaceasoft.firoozboard.databinding.FragmentLoginUserItemBinding;
...
public class MyItemFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
        ...
        ItemVerticalListAdapter userItemAdapter = new ItemVerticalListAdapter(dataBindingComponent,
                new ItemVerticalListAdapter.NewsClickCallback() {
                    ...
                    public void onClick(Item item) {
                        navigationController.navigateToItemDetailActivity(MyItemFragment.this.getActivity(), item.id, item.title);
                    }
                },this);
