...
import com.panaceasoft.firoozboard.databinding.FragmentItemLocationBinding;
...
public class ItemLocationFragment extends PSFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (getActivity() != null) {
            ...
            if (getActivity().getIntent().getStringExtra(Constants.LOCATION_FLAG).equals(Constants.LOCATION_NOT_CLEAR_ICON)) {
                ...
                binding.get().constraintLayout14.setVisibility(View.VISIBLE);
                binding.get().SeeAllItems.setVisibility(View.VISIBLE);
            } else {

                setHasOptionsMenu(true);
                binding.get().constraintLayout14.setVisibility(View.GONE);
                binding.get().SeeAllItems.setVisibility(View.GONE);
    ...
    protected void initUIAndActions() {
        ...
        binding.get().SeeAllItems.setOnClickListener(view -> {

            navigationController.navigateToMainActivity(this.getActivity(), "", getString(R.string.location_see_all), "", "");
