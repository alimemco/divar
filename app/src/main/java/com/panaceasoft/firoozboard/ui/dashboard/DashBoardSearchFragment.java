...
import com.panaceasoft.firoozboard.databinding.FragmentDashboardSearchBinding;
...
public class DashBoardSearchFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initUIAndActions() {
        ...
        binding.get().filter.setOnClickListener(view -> {
            ...
            // Set to Intent
            navigationController.navigateToHomeFilteringActivity(this.getActivity(), itemViewModel.holder, null , itemViewModel.holder.lat,itemViewModel.holder.lng,Constants.MAP_MILES,selected_location_id);
