...
import com.panaceasoft.firoozboard.databinding.FragmentUserLoginBinding;
            ...
            if (listResource != null) {
                ...
                switch (listResource.status) {
                    ...
                    case SUCCESS:
                        ...
                        if (listResource.data != null) {
                            ...
                            userViewModel.setLoadingState(false);
                                ...
                                try {
                                    if(getActivity() != null) {
                                        Toast.makeText(getContext(), R.string.message__login_success, Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(getActivity(), AppLoadingActivity.class);
                    ...
                    case ERROR:
                        ...
                        psDialogMsg.showErrorDialog("شماره تلفن یا رمز عبور اشتباه است", getString(R.string.app__ok));
                        psDialogMsg.show();
