...
import com.panaceasoft.firoozboard.databinding.FragmentAppLoadingBinding;
...
//        }
    ...
    protected void initData() {
        ...
        if (connectivity.isConnected()) {
            ...
            if (selected_location_name.equals(getString(R.string.location_see_all))) {
                navigationController.navigateToMainActivity(getActivity(), "", getString(R.string.location_see_all), "", "");
            }else if(!selected_location_id.isEmpty()) {
