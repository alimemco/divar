...
import com.panaceasoft.firoozboard.databinding.FragmentAppInfoBinding;
...
/*                String dial = "tel:" + number2;
        ...
        //For website
        binding.get().telegramTextView.setOnClickListener(view -> {
            String url = binding.get().telegramTextView.getText().toString();
    ...
    private void setAboutUsData(AboutUs aboutUs) {
        ...
        if (aboutUs.aboutEmail.equals("")) {
            ...
            binding.get().pinterestTextView.setText(aboutUs.aboutEmail);
        ...
        if (aboutUs.pinterest.equals("")) {
            binding.get().telegramImage.setVisibility(View.GONE);
            binding.get().telegramTextView.setVisibility(View.GONE);
            binding.get().telegramTitleTextView.setVisibility(View.GONE);
        } else {

            binding.get().telegramTextView.setText(aboutUs.pinterest);
            binding.get().telegramImage.setVisibility(View.VISIBLE);
            binding.get().telegramTextView.setVisibility(View.VISIBLE);
            binding.get().telegramTitleTextView.setVisibility(View.VISIBLE);
        }
        ...
        if (aboutUs.aboutPhone.equals("")) {
            ...
            binding.get().gplusTextView.setText(aboutUs.aboutPhone);
