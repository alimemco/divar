...
import com.panaceasoft.firoozboard.databinding.FragmentGalleryDetailBinding;
...
import com.panaceasoft.firoozboard.utils.TouchImageView;
...
public class GalleryDetailFragment extends PSFragment {
    ...
    protected void initUIAndActions() {
        ...
        binding.get().btnClose.setOnClickListener(view -> {
                if (getActivity() != null) {
                    getActivity().finish();
                }
