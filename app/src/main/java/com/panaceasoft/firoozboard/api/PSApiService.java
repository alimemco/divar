...
import com.panaceasoft.firoozboard.viewobject.ChatHistory;
import com.panaceasoft.firoozboard.viewobject.City;
...
import com.panaceasoft.firoozboard.viewobject.ItemSubCategory;
...
import com.panaceasoft.firoozboard.viewobject.Rating;
...
public interface PSApiService {
    ...
    Call<ApiStatus> deleteItem(@Path("API_KEY") String apiKey, @Field("item_id") String item_id);
    ...
    Call<ApiStatus> deleteUser(@Path("API_KEY") String apiKey, @Field("user_id") String user_id);
    ...
    LiveData<ApiResponse<List<com.panaceasoft.firoozboard.viewobject.Comment>>> getCommentList(@Path("API_KEY") String apiKey, @Path("item_id") String itemId, @Path("limit") String limit, @Path("offset") String offset);

    //endregion

    //region Get comment detail list
    @GET("rest/commentdetails/get/api_key/{API_KEY}/header_id/{header_id}/limit/{limit}/offset/{offset}")
    LiveData<ApiResponse<List<com.panaceasoft.firoozboard.viewobject.CommentDetail>>> getCommentDetailList(@Path("API_KEY") String apiKey, @Path("header_id") String headerId, @Path("limit") String limit, @Path("offset") String offset);
